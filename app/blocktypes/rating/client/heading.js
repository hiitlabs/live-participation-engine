...
if (__CONTROL__) {
  var initHeadingEdit = function(block, $heading) {
    ...
    // Experimenting with custom longpress for mobile
    //var pressTimer;
    //$heading.on('mousedown', function() {
    //  pressTimer = setTimeout(function() {
    //    $heading.trigger('dblclick');
    //  }, 700);
    //});
    // Mouseup does not fire if mouse is dragged away from the heading
    //$heading.on('mouseup', function() {
