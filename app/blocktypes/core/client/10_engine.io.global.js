/** engine.io-client@0.7.x MIT Copyright (c) 2011 Guillermo Rauch <guillermo@learnboost.com> */
...
Socket.prototype.onHeartbeat = function (timeout) {
  ...
  self.pingTimeoutTimer = setTimeout(function () {
    ...
    // pete fix (or experiment)
    //self.transport.close('ping timeout');
...
Socket.prototype.onClose = function (reason, desc) {
  if ('opening' == this.readyState || 'open' == this.readyState) {
    ...
    // pete fix: ensure transport is closed
    // important if ping timeout before open
    // does it need try catch?
    this.transport.close();
...
// pete fix from https://github.com/mokesmokes/engine.io-client/commit/9af2430dbbd2be6474755f8973abc1cb51230a44
/*
Polling.prototype.doClose = function(){
  // brute force close
...
Request.prototype.create = function(){
  ...
  //xhr.send(this.data);
  // pete fix from https://github.com/goinstant/engine.io-client/commit/cedca5699fb27feed101c2448d34cbb369c0730d
  try {
    xhr.send(this.data);
  } catch (e) {
...
Request.prototype.cleanup = function(){
  ...
  // pete fix from https://github.com/LearnBoost/engine.io-client/issues/180
...
// Expose these in client code via require('io')
//exports.emitter = require('emitter');
//exports.eio = require('engine.io');
...
require.alias("learnboost-engine.io-client/lib/index.js", "components/deps/engine.io/lib/index.js");
require.alias("learnboost-engine.io-client/lib/socket.js", "components/deps/engine.io/lib/socket.js");
require.alias("learnboost-engine.io-client/lib/transport.js", "components/deps/engine.io/lib/transport.js");
require.alias("learnboost-engine.io-client/lib/emitter.js", "components/deps/engine.io/lib/emitter.js");
require.alias("learnboost-engine.io-client/lib/util.js", "components/deps/engine.io/lib/util.js");
require.alias("learnboost-engine.io-client/lib/transports/index.js", "components/deps/engine.io/lib/transports/index.js");
require.alias("learnboost-engine.io-client/lib/transports/polling.js", "components/deps/engine.io/lib/transports/polling.js");
require.alias("learnboost-engine.io-client/lib/transports/polling-xhr.js", "components/deps/engine.io/lib/transports/polling-xhr.js");
require.alias("learnboost-engine.io-client/lib/transports/polling-jsonp.js", "components/deps/engine.io/lib/transports/polling-jsonp.js");
require.alias("learnboost-engine.io-client/lib/transports/websocket.js", "components/deps/engine.io/lib/transports/websocket.js");
require.alias("learnboost-engine.io-client/lib/transports/flashsocket.js", "components/deps/engine.io/lib/transports/flashsocket.js");
require.alias("learnboost-engine.io-client/lib/index.js", "components/deps/engine.io/index.js");
